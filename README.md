...
- **Test coverage is partial**: `tests/` covers score classification, required-column validation, and the download route, but not `search_product`'s DuckDuckGo/similarity-matching logic.
